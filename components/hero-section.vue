      ...
      <div class="relative px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl flex items-center h-full">
        ...
        <div class="relative lg:w-1/3 text-right lg:pr-16 mt-auto fadeInRight">
          ...
          <div class="relative inline-flex items-center justify-center mt-4 sm:mt-6 group">
            ...
            <NuxtLink to="/virtual-assistant" title="" class="relative inline-flex items-center justify-center px-8 py-3 text-base font-normal text-orange-100 bg-blue border border-transparent rounded-full hover:bg-orange-100 hover:text-blue" role="button"> Chat Now </NuxtLink>
          </div>
        </div>
      </div>
    </section>
