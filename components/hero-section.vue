    ...
    <section class="py-12 bg-black sm:pb-16 lg:pb-20 xl:pb-24 relative" :style="heroStyle">
      ...
      <div class="relative px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl flex items-center h-full">
        <div class="relative fadeInLeft">
          <div class="lg:w-2/3 text-orange-100">
            <h1 class="mt-6 text-4xl  sm:mt-10 sm:text-5xl lg:text-6xl xl:text-8xl">
              <span class=" bg-clip-text bg-gradient-to-r from-cyan-500 to-purple-500">You're not alone</span>
            </h1>
            <p class="max-w-lg mt-4 text-xl sm:mt-8">Join us in providing support, resources, and a safe haven for women affected by violence</p>
          </div>
        </div>
        <div class="relative lg:w-1/3 text-right lg:pr-16 mt-auto fadeInRight">
          ...
          <div class="relative inline-flex items-center justify-center mt-4 sm:mt-6 group">
            ...
            <NuxtLink to="/virtual-assistant" title="" class="relative inline-flex items-center justify-center px-8 py-3 text-base text-orange-100 bg-red border border-transparent rounded-full hover:bg-orange-100 hover:text-red" role="button"> Chat Now </NuxtLink>
          </div>
        </div>
      </div>
    </section>
