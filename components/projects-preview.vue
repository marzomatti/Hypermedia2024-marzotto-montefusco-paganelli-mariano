    ...
    <div class="container mx-auto">
      <div class="p-6 rounded-lg">
        <div class="items-center mb-6 mt-4 ">
          <h2 class="hiddenItem text-4xl font-extrabold text-blue text-center">Most Relevant Projects</h2>
        </div>
        <div class="hiddenItem grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          <nuxt-link
        ...
        <div class="hiddenItem flex justify-center mt-6">
          <Button :text="'See all projects &rarr;'" :link="'/activities/projects'" class="mt-4"/>
        </div>
      </div>
    </div>
  </section>
