            ...
            <div class="absolute inset-y-0 right-0 flex items-center color-blue pr-3">
              <button @click="clearSearch" v-if="searchQuery" class="text-blue h-4 w-4 mr-2 focus:outline-none">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
                  <path fill-rule="evenodd" d="M10 8.586L4.707 3.293a1 1 0 00-1.414 1.414L8.586 10l-5.293 5.293a1 1 0 001.414 1.414L10 11.414l5.293 5.293a1 1 0 001.414-1.414L10 8.586z" clip-rule="evenodd"/>
                </svg>
              </button>
