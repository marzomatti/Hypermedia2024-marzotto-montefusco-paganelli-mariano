  ...
  <main>
    <div class="container mx-auto px-12 py-12">
      ...
      <div class="flex flex-col items-center mb-8">
        <p class="text-center text-lg text-gray-700 max-w-5xl">
      ...
      <div class="md:flex mb-8 items-stretch">
        ...
        <div class="md:w-1/2 p-7">
          <form @submit.prevent="submitForm" class="bg-white p-6 rounded-3xl shadow-lg h-full">
            ...
            <button type="submit" class="w-full bg-primary-color text-white p-3 rounded-3xl hover:bg-red-700 mt-4">Send</button>
          </form>
        </div>
      </div>
